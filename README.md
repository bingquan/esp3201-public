...
- `mini_assignments/week10_trustworthy_ai_probe/starter/notebooks/week10b_agentic_security_colab_v6.ipynb` — Week 10b, current version: a 30–45-minute core lab with seven local-model trials covering prompt injection, a deletion gate, and keyword filtering. Runs Qwen2.5-1.5B-Instruct in FP16 on a Colab T4 GPU; no API key or inference API quotas. Includes readable filter tables, paired results, and recorded local-model examples. Internet is needed for the initial model download.
- `mini_assignments/week10_trustworthy_ai_probe/starter/notebooks/week10b_agentic_security_colab_v5.ipynb` — Week 10b v5, retained as the Gemini API alternative; requires a `GEMINI_API_KEY` and a CPU runtime.
- `mini_assignments/week10_trustworthy_ai_probe/starter/notebooks/week10b_agentic_security_colab_v4.ipynb` — Week 10b v4, kept for reference.
