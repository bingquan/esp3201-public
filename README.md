...
- `mini_assignments/week10_trustworthy_ai_probe/starter/notebooks/week10b_agentic_security_colab_v5.ipynb` — Week 10b, current version: a 30–45-minute core lab with seven live trials covering indirect prompt injection, action permission gates, and keyword filtering. Includes clearer input/match/withholding tables, paired results, and optional revision/model experiments. Uses the Gemini API with a `GEMINI_API_KEY`; CPU runtime, no GPU required.
